# UXE - Grids and images oh myyyyy
...
* Taking either the project you refactored or the one you started, use a combination of a grid system and flexbox to re-engineer the layout of the view.
...
* Add responsive images using the technology available
  * Looking for the image to be responsive to space
  * Looks good on retina
  * Is hopefully NOT super large to download
